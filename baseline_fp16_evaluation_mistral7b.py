...
# ============================================================
print("\n" + "="*80)
print("STEP 1: Computing Perplexity on WikiText-2")
print("="*80)
...
print("\n" + "="*80)
print("STEP 2: Generating Responses for 96 Prompts")
print("="*80)
...
# ============================================================
print("\n" + "="*80)
print("STEP 3: Compiling Baseline Metrics")
print("="*80)
...
for i, result in enumerate(gen_results):
    ...
    baseline_metrics['prompt_responses'].append(result)
...
baseline_metrics['category_statistics'] = category_stats

# Save results
output_file = "baseline_fp16_mistral7b_results.json"
...
print(f"Average Generation Time: {baseline_metrics['generation_metrics']['average_time_per_prompt']:.2f}s")
print(f"Average Tokens/Second: {baseline_metrics['generation_metrics']['average_tokens_per_second']:.2f}")
...
print(f"\n✅ Mistral-7B FP16 baseline evaluation completed!")
